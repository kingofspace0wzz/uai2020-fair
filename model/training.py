...
from model.utils.modelIO import save_model
...
class FairTrainer(Trainer):
    def __init__(self, model, critic, optimizer, loss_f,
                 device=torch.device("cpu"),
                 logger=logging.getLogger(__name__),
                 hyperparams={'a1':1, 'a2':1},
                 save_dir="results",
                 gif_visualizer=None,
                 is_progress_bar=True):
        super().__init__(model, optimizer, loss_f,
                        device=torch.device("cpu"),
                        logger=logging.getLogger(__name__),
                        save_dir="results",
                        gif_visualizer=None,
                        is_progress_bar=True)
        self.a1, self.a2 = hyperparams['a1'], hyperparams['a2']
        self.critic = critic
